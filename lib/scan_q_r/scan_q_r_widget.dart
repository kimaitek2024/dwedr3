...
class _ScanQRWidgetState extends State<ScanQRWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.sCanning = await FlutterBarcodeScanner.scanBarcode(
      ...
      await notificationsRecordReference.set(createNotificationsRecordData(
        notificationId:
            random_data.randomInteger(10000000, 99999999).toString(),
        timeCreated: getCurrentTimestamp,
        sender: _model.attendanceScan?.sender,
        message: _model.sCanning,
        idNumber: _model.sCanning,
        timeIn: getCurrentTimestamp,
      ));
      _model.attendanceScan = NotificationsRecord.getDocumentFromData(
