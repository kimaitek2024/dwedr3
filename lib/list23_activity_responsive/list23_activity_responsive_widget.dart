...
import 'list23_activity_responsive_model.dart';
export 'list23_activity_responsive_model.dart';

class List23ActivityResponsiveWidget extends StatefulWidget {
  const List23ActivityResponsiveWidget({super.key});

  @override
  State<List23ActivityResponsiveWidget> createState() =>
      _List23ActivityResponsiveWidgetState();
}

class _List23ActivityResponsiveWidgetState
    extends State<List23ActivityResponsiveWidget> {
  late List23ActivityResponsiveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => List23ActivityResponsiveModel());
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      fadeOutDuration:
                                          const Duration(milliseconds: 500),
                                      imageUrl:
                                          'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/a-a-n-p-school-p2tmql/assets/6kkat8fo1k35/271149027_142675374794501_555119597510816979_n.png',
                                      width: 44.0,
                                      height: 44.0,
                                      fit: BoxFit.cover,
                                    ),
