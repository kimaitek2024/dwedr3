...
class _CreateAnnouncementWidgetState extends State<CreateAnnouncementWidget>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.titleTextController?.text = 'Wonderfull AANP';
          _model.descriptionTextController?.text =
              'Add description to your  announcements!';
        }));
  }
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                var announcementsRecordReference =
                                    AnnouncementsRecord.collection.doc();
                                await announcementsRecordReference
                                ...
                                _model.postNew =
                                    AnnouncementsRecord.getDocumentFromData(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await listViewAnnouncementsRecord!.reference
                                    .update(createAnnouncementsRecordData(
